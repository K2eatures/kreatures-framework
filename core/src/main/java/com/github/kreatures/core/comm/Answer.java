package com.github.kreatures.core.comm;
 ...
 * but the {@link Answer} speech-act also stores an {@link KReaturesAnswer} containing an {@link AnswerValue}, 
...
public class Answer extends SpeechAct {
	...
	private KReaturesAnswer answer;
	...
	public void setAnswer(KReaturesAnswer val) {
		answer = val;
	}
	
	/** @return the value of the answer */
	public KReaturesAnswer getAnswer() {
		return answer;
	}
	...
	public Context getContext() {
		...
		KReaturesAnswer answer = getAnswer();
