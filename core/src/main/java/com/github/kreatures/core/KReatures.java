...
import com.github.kreatures.core.internal.OperatorMap;
...
/**
 * Main class of KReatures manages all resources.
 * 
...
public class KReatures {
	...
	/** the only instance of KReatures */
	...
	public KReaturesProject getProject() {
	 ...
	 * to the KReatures Report-System. No attachment is given to the report entry.
	 ...
	 * to the KReatures Report-System. A copy of the attachment is saved in the report
	 * system.
	 * @param msg			String representing the message.
	 ...
	 */
	protected void onCreateSimulation(KReaturesEnvironment ev) {
...
//	}
	 ...
	 */
	protected void onNewSimulation(KReaturesEnvironment ev) {
		for(SimulationListener l : simulationListeners) {
	 ...
	 */
	protected void onSimulationDestroyed(KReaturesEnvironment ev) {
		actualReport = null;
		reports.clear();
		for(SimulationListener l : simulationListeners) {
	...
	/**
	 * Helper method: Called to inform all KReatures error listeners about an error.
