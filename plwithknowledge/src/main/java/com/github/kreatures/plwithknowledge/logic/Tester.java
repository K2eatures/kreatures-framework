...
public class Tester {
	...
	public static void main(String[] args){
		...
		Pair<Set<FolFormula>, KReaturesAnswer> answer = queryImpl(bbase, query);
	...
	protected static Pair<Set<FolFormula>, KReaturesAnswer> queryImpl(
		...
		return new Pair<Set<FolFormula>, KReaturesAnswer>(answers, new KReaturesAnswer(query, answer));
	}
