 ...
 *
 */
public class SwarmBehavior_old extends SimpleBehavior{
	private static final Logger LOG = LoggerFactory.getLogger(SwarmBehavior_old.class);
	...
	public boolean findNextStation(StatusAgentComponents statusAgent, DefaultStation current, SwarmMappingGeneric swarmMapping){
		for(DefaultEdge edge: current.getHashTableofEdge().values()){ 
