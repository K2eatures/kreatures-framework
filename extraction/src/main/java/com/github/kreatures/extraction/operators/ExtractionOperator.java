 ...
 *
 */
public class ExtractionOperator extends Operator<Agent, OperatorPluginParameter, Void> {

	public static final String OPERATION_TYPE = "Extraction";

	@Override
	public Pair<String, Class<?>> getOperationType() {
		return new Pair<String, Class<?>>(OPERATION_TYPE, ExtractionOperator.class);
	}
