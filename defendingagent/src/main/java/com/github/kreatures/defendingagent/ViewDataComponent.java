 ...
 * @see kreatures.defendingagent.View for details on views.
 * @see kreatures.defendingagent.ViewWithCompressedHistory for detail on views.
 * @see kreatures.defendingagent.ViewWithHistory for detail on views.
 * 
