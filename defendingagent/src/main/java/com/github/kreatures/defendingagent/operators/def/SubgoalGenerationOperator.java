...
import com.github.kreatures.defendingagent.comm.RevisionAnswer;
import com.github.kreatures.defendingagent.comm.UpdateAnswer;
...
public class SubgoalGenerationOperator extends BaseSubgoalGenerationOperator {
	...
	public boolean processQuery(Desire desire, PlanParameter pp, AgentAbstract ag) {
		...
		KReaturesAnswer answer = ag.getBeliefs().getWorldKnowledge().reason(query.getQuestion());
		if(history != null){
